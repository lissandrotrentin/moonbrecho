...
$sqlcode = "SELECT * FROM estoque where id_produto = '$id'";
...
$sql_code = "INSERT INTO vendas values ('null','$id2', '$id_cliente', '$descricao', '$preco_compra', '$preco_venda', '$hoje')";
$sql_query = $mysqli->query($sql_code);

$hoje_d = date('d');


$sql_code_m = "INSERT INTO vendas_mes values ('$id2', '$id_cliente', '$descricao', '$preco_compra', '$preco_venda', '$hoje_d')";
$sql_query_m = $mysqli->query($sql_code_m);
    ...
    $sql_code = "INSERT INTO vendas_aberto values ('null','$id2', '$id_cliente', '$descricao', '$preco_compra','$pagamento','$preco_venda', '$hoje')"; 
    $sql_query = $mysqli->query($sql_code);
